...
<?php
$sql_pro = "SELECT * FROM product,category WHERE product.category_id = category.category_id AND product.statuspr = 1 AND product.quantity != 0 ORDER BY product.product_id DESC LIMIT 25";
