...
if (isset($_POST['themsanpham'])) {
    ...
    //sua
    if ($hinhanh != '') {
        $spl_update = "UPDATE product SET name_product='" . $tensanpham . "',idproduct='" . $masp . "',thumbnail='" . $hinhanh . "',descriptions='" . $noidung . "',console_type='" . $hemaysp . "',languages='" . $ngonngusp . "',player='" . $songuoichoi . "',price='" . $giasp . "',quantity='" . $soluong . "',publisher_name='" . $nhaxuatban . "',statuspr='" . $tinhtrang . "',esrb='" . $dotuoi . "' WHERE product_id='$_GET[idsanpham]'";
        move_uploaded_file($hinhanh_tmp, 'uploads/' . $hinhanh);
        $id = $_GET['idsanpham'];
        ...
        $spl_update = "UPDATE product SET name_product='" . $tensanpham . "',idproduct='" . $masp . "',descriptions='" . $noidung . "',console_type='" . $hemaysp . "',languages='" . $ngonngusp . "',player='" . $songuoichoi . "',price='" . $giasp . "',quantity='" . $soluong . "',publisher_name='" . $nhaxuatban . "',statuspr='" . $tinhtrang . "',esrb='" . $dotuoi . "' WHERE product_id='$_GET[idsanpham]'";
    }
