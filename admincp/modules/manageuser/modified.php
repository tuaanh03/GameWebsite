    ...
    <form method="POST">
        <tbody>
            ...
            <tr>
                ...
                <td><input value="<?php echo $name ?>" readonly id="name" name="name" placeholder="Username" type="text"></td>
            </tr>

            <tr>
                <th scope="row">Email</th>
                <td><input value="<?php echo $email ?>" readonly id="lastname" name="email" placeholder="Email" type="text"></td>
            </tr>
            <tr>
                <th scope="row">Full name</th>
                <td><input value="<?php echo $fullname ?>" id="lastname" name="fullname" placeholder="Full Name" type="text"></td>
            </tr>
            <tr>
                <th scope="row">Phone number</th>
                <td><input value="<?php echo $phone ?>" id="name" name="phonenumber" placeholder="Phone Number" type="text"></td>
            </tr>

            <tr>
                <th scope="row">Province</th>
                <td> <label for="province" class="col-4 col-form-label">Province / City</label>
                    <div class="col-8">
            ...
            <tr>
                ...
                <td><label for="district" class="col-4 col-form-label">District</label>
                    <div class="col-8">
            ...
            <tr>
                ...
                <td><label for="ward" class="col-4 col-form-label">Ward</label>
                    <div class="col-8">
            ...
            <tr>
                ...
                <td><input value="<?php echo $streetaddress ?>" id="lastname" name="streetaddress" placeholder="Street Address" type="text"></td>
            </tr>
